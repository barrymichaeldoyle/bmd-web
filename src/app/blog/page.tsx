    ...
    <>
      ...
      {posts.map(({ id, uid, data, tags }) => (
        <Link key={id} href={`/blog/${uid}`}>
          <article className="mb-8 p-4 shadow-lg rounded-lg bg-white dark:bg-gray-800 cursor-pointer hover:shadow-xl hover:bg-gray-50 dark:hover:bg-gray-700 transition">
